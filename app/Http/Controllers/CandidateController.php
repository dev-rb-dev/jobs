...
class CandidateController extends AppBaseController
{
    ...
    {
        if ($request->ajax()) {
            return Datatables::of((new CandidateDataTable())->get($request->only([
                'immediate_available', 'is_active', 'job_skill',
            ])))->make(true);
        }
    ...
    {
        if ($request->ajax()) {
            return Datatables::of((new AllResumeDataTable())->get())->make(true);
        }
