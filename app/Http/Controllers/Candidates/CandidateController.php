...
use App\Queries\FavouriteJobsDataTable;
use App\Queries\ResumeDataTable;
...
class CandidateController extends AppBaseController
{
    ...
    public function editProfile(Request $request)
    {
        ...
        if ($sectionName == 'resumes') {
            if ($request->ajax()) {
                return Datatables::of((new ResumeDataTable())->get($user->candidate->id))->make(true);
            }
        }
    ...
    {
        if ($request->ajax()) {
            return Datatables::of((new FavouriteJobsDataTable())->get())->make(true);
        }
    ...
    public function deleteFavouriteJob(FavouriteJob $favouriteJob)
    {
        ...
        return $this->sendSuccess('Favourite Job has been removed.');
    }
