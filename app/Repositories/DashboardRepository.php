...
class DashboardRepository
{
    ...
    public function getEmployerDashboardData()
    {
        ...
        $data['draftedJobCount'] = Job::whereCompanyId($user->owner_id)->where('status', Job::STATUS_DRAFT)->count();
    ...
    {
        return  DB::table('admin_notice_boards')->where('notification_type', 1)->get();
    }
