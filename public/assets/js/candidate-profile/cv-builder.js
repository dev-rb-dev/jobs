...
$(document).ready(function () {
  ...
  $(document).on('click', '.printCV', function () {
    ...
    newWin.document.write('<html>' + '<link href="' + pluginUrl + '" rel="stylesheet" type="text/css"/>' + '<link href="' + styleCssUrl + '" rel="stylesheet" type="text/css"/>' + // '<link href="' + customCssUrl +
    // '" rel="stylesheet" type="text/css"/>' +
    '<link href="' + fontCssUrl + '" rel="stylesheet" type="text/css"/>' + '<body onload="window.print()">' + divToPrint.innerHTML + '</body></html>');
