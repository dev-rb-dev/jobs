...
$(tableName).DataTable({
  ...
  columns: [{
    ...
    data: function data(row) {
      return "<a href=\"".concat(jobDetailsUrl, "/").concat(row.job.job_id, "\" target=\"_blank\">").concat(row.job.job_title, "</a>");
    },
    name: 'job.job_title'
  }, {
    data: function data(row) {
      return "<div class=\"d-flex align-items-center\">\n                        <div class=\"symbol symbol-circle symbol-50px overflow-hidden me-3\">\n                            <a>\n                                <div class=\"\">\n                                    <img src=\"".concat(row.job.company.user.avatar, "\" alt=\"\" class=\"user-img\">\n                                </div>\n                            </a>\n                        </div>\n                        <div class=\"d-flex flex-column\">\n                            <a class=\"mb-1\">").concat(row.job.company.user.first_name, "</a>\n                            <span>").concat(row.job.company.user.email, "</span>\n                        </div>\n                    </div>");
    },
    name: 'user.first_name'
  }, {
    data: function data(row) {
      return "<div class=\"badge badge-light\">\n                    <div> ".concat(moment(row.job.created_at, 'YYYY-MM-DD hh:mm:ss').format('Do MMM, YYYY'), "</div>\n                    </div>");
    },
    name: 'created_at'
  }, {
    data: function data(row) {
      ...
      if (todayDate > row.job.job_expiry_date) {
        return "<div class=\"badge badge-light-danger\">\n                        <div> ".concat(moment(row.job.job_expiry_date, 'YYYY-MM-DD hh:mm:ss').format('Do MMM, YYYY'), "</div>\n                        </div>");
      }
