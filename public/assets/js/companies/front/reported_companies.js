...
var tbl = tableName.DataTable({
  ...
  columns: [{
    data: function data(row) {
      return "<div class=\"d-flex align-items-center\">\n                            <div class=\"symbol symbol-circle symbol-50px overflow-hidden me-3\">\n                                <a >\n                                    <div class=\"\">\n                                        <img src=\"".concat(row.company.company_url, "\" alt=\"\" class=\"user-img\">\n                                    </div>\n                                </a>\n                           </div>\n                           <div class=\"d-flex flex-column\">\n                                <a href=\"javascript:void(0)\" class=\"mb-1 show-btn\" data-id=\"").concat(row.id, "\">").concat(row.company.user.full_name, "</a>\n                            </div>\n                         </div>");
    },
    name: 'company.user.first_name'
  }, {
    data: function data(row) {
      return "<span>".concat(row.user.first_name, " ").concat(row.user.last_name, "</span>");
    },
