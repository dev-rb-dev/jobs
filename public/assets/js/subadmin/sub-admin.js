...
/*!***************************************************!*\
  !*** ./resources/assets/js/subadmin/sub-admin.js ***!
  \***************************************************/


$(document).ready(function () {
  var tableName = '#subadminTbl';
  var tbl = $(tableName).DataTable({
    ...
    columns: [{
      data: function data(row) {
        return '<a class="show-btn cursor-pointer" data-id="' + row.id + '">' + row.full_name + '</a>';
      },
      ...
      data: function data(row) {
        var url = subadminUrl + '/' + row.id;
        var data = [{
          'id': row.id,
          'url': url + '/edit'
        }];
        return prepareTemplateRender('#subadminActionTemplate', data);
      },
      name: 'id'
    }],
  ...
  $(document).on('click', '.delete-btn', function (event) {
    ...
    deleteItem(subadminUrl + '/' + userId, tableName, Lang.get('messages.company.employer'));
