          ...
          value: function value(t) {
            ...
            if (o && 11 === o[1].length) {
              ...
              if (void 0 !== o[2]) {
                ...
                if (y) for (var k = [3600, 60, 1], w = 0, C = k.length; w < C; w++) {
            ...
            } else if (f || p || v) n = e()("<video controls>").attr("src", t).attr("width", "640").attr("height", "360");else {
