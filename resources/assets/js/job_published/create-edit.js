...
$(document).ready(function () {
    if ($('#editDetails').length) {
        let editJobDescription = new Quill('#editDetails', {
            modules: {
                toolbar: [
...
if($('#jobTypeDescription').length){
    let jobTypeDescription = new Quill('#jobTypeDescription', {
        modules: {
            toolbar: [
                ['bold', 'italic', 'underline', 'strike'],
                ['clean'],
...
if ($('#skillDescription').length){
    ...
    let skillDescription = new Quill('#skillDescription', {
        modules: {
            toolbar: [
                ['bold', 'italic', 'underline', 'strike'],
                ['clean'],
...
if ($('#jobTagDescription').length){
    let jobTagDescription = new Quill('#jobTagDescription', {
        modules: {
            toolbar: [
                ['bold', 'italic', 'underline', 'strike'],
                ['clean'],
...
if($('#jobShiftDescription').length){
    ...
    let jobShiftDescription = new Quill('#jobShiftDescription', {
        modules: {
            toolbar: [
                ['bold', 'italic', 'underline', 'strike'],
                ['clean'],
...
if($('#salaryPeriodDescription').length){
    let salaryPeriodDescription = new Quill('#salaryPeriodDescription', {
        modules: {
            toolbar: [
                ['bold', 'italic', 'underline', 'strike'],
                ['clean'],
