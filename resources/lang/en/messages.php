<?php return [
 ...
 'no_keyword_found' => 'No Keyword Found',
    ...
    'admin_notice_board' =>[
        'admin_notice_board' => 'Notice Board',
        'new_notice_board'  => 'New Notice',
        'edit_notice_board' => 'Edit Notice',
        'show_notice_board' => 'Notice',
        'select_notice_type' => 'Select Role Type',
        'name' => 'Name',
        'description' => 'Description',
        'add' => 'Add',
        'action' => 'Action',
        'notice_board_detail' => 'Notice Details',
        'no_notice_board_found' => 'No Notice Found',
        'no_notice_board_available' => 'No Notice Available',
    ],
    'post_category' => [
