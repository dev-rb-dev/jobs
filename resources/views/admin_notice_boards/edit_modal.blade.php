...
<div id="editModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{__('messages.admin_notice_board.edit_notice_board') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('name',__('messages.admin_notice_board.name').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::text('name', null, ['id' => 'editName','class' => 'form-control form-control-solid','required', 'placeholder'=> __('messages.admin_notice_board.name')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                      {{ Form::label('notification_type', __('messages.admin_notice_board.select_notice_type').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }} <span class="text-danger">*</span>
                        {{ Form::select('notification_type', ['Candidate','Employer'], 'Candidate', ['id' => 'notificationType','class' => 'form-control form-control-solid','required']) }}


                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('description', __('messages.admin_notice_board.description').(':'),['class' => 'required form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
                        <div id="editDescription"></div>
                        {{ Form::hidden('description', null, ['id' => 'edit_admin_notice_board_desc']) }}
                    </div>
