<div id="addModal" tabindex="-1" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{__('messages.branding_slider.new_branding_slider')}}</h2>
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        <div class="row">
                            <div class="form-group col-sm-12 mb-5">
                                ...
                                {{ Form::text('title', null, ['class' => 'form-control form-control-solid', 'id' => 'title', 'required', 'placeholder' =>  __('messages.candidate_profile.title')]) }}
                            </div>
                            <div class="form-group col-sm-12 mb-5">
                                <div class="row2">
                                    <div class="d-block">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true">
                                        ...
                                        <label
                                            ...
                                            {{ Form::file('branding_slider',['id'=>'brandingSlider','class' => 'd-none', 'accept' => '.png, .jpg, .jpeg']) }}
