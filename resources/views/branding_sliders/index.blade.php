        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center py-1">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-5">
                                    ...
                                    {{ Form::select('is_active', $statusArr,null, ['id' => 'branding_filter_status', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-filter select2-hidden-accessible data-allow-clear="true"','placeholder' => __('messages.image_slider.select_status')]) }}
                                </div>
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary addBrandingSliderModal"> <i
