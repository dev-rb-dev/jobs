    ...
    <div class="slot-box rounded shadow mb-5">
                        <div class="row p-5">
                            <div class="form-group col-sm-12 mb-2">
                                <span class="fw-bolder">{{:schedule_date}} - {{:schedule_time}}</span>
                            </div>
                            <div class="form-group col-sm-12 mb-2">
                            ...
                            <div class="form-group col-sm-12 mb-0">
                                <div class="form-check form-check-custom form-check-solid is-valid form-check-sm">
                                    ...
                                    <label class="custom-control-label fw-bolder" for="{{:index}}"><?php echo __('messages.job_stage.slot_preference') ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="p-5 rounded shadow mb-5">
    <div class="d-flex justify-content-between">
          <span class="fw-bolder">{{:companyName}}</span>
          <span class="fw-bolder">{{:schedule_created_at}}</span>
     </div>
     <span class="fw-bolder">{{:notes}}</span>
     </div>
