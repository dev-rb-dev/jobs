<div class="col">
    @if(isset($user->facebook_url))
        <a class="fw-bold" href="{{ $user->facebook_url }}"
    ...
    @if(isset($user->twitter_url))
        <a class="fw-bold" href="{{ $user->twitter_url }}"
    ...
    @if(isset($user->linkedin_url))
        <a class="fw-bold" href="{{ $user->linkedin_url }}"
    ...
    @if(isset($user->google_plus_url))
        <a class="fw-bold" href="{{ $user->google_plus_url }}"
    ...
    @if(isset($user->pinterest_url))
        <a class="fw-bold" href="{{ $user->pinterest_url }}"
