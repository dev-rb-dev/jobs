        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="article-cta candidate-experience-edit-delete">
                                        <a href="javascript:void(0)"
                                           ...
                                           title="Edit"
                                           data-id="{{:id}}"><span class="svg-icon svg-icon-3">
...
<script id="candidateEducationTemplate" type="text/x-jsrender">
  <div class="col-12 col-sm-12 col-md-12 col-lg-12 candidate-education shadow rounded p-5 mb-5" data-education-id="{{:candidateEducationNumber}}" data-id="{{:id}}">
      <article class="article article-style-b">
          <div class="article-details">
          <div class="d-flex justify-content-between">
              <div class="article-title">
  ...
  data-experience-id="{{:candidateExperienceNumber}}" data-id="{{:id}}">
      <article class="article article-style-b">
          ...
          <div class="d-flex justify-content-between">
              ...
              <div class="article-cta candidate-experience-edit-delete">
                        <a href="javascript:void(0)"
                           class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-experience"
                           title="Edit"
                           data-id="{{:id}}"><span class="svg-icon svg-icon-3">
        ...
        <article class="article article-style-b">
            <div class="article-details border-0">
              <div class="d-flex justify-content-between">
                ...
                <div class="article-cta candidate-education-edit-delete">
                        <a href="javascript:void(0)"
                           class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-education"
                           title="Edit"
                           data-id="{{:id}}">
