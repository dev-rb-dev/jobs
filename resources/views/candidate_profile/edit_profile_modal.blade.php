...
{{--                        {{ Form::text('last_name', null, ['id'=>'lastName','class' => 'form-control','required', 'placeholder' => __('messages.candidate.last_name')]) }}--}}
{{--                    </div>--}}
{{--                    <div class="form-group col-sm-6">--}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('last_name',__('messages.candidate.last_name').(':'),['class' => 'form-label fs-6 fw-bolder required text-gray-700 mb-3']) }}
                    ...
                    <div class="form-group col-sm-4 mb-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            <div class="image-input-wrapper w-125px h-125px bgi-position-center"
                                 id='profilePicturePreview' style="background-image: url({{ asset('assets/img/infyom-logo.png') }})">
                            </div>
                            <label
