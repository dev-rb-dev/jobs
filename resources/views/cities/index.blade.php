            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex align-items-center py-1">
                        @if(count($states) > 0)
                            <div class="me-4">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                                    ...
                                    <div class="px-7 py-5">
                                        <div class="mb-5">
                                            {{ Form::select('states', $states, null, ['id' => 'filter_state', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-filter select2-hidden-accessible data-allow-clear="true"','placeholder' => 'Select State']) }}
                                        </div>
                        ...
                        @endif
                        <a class="btn btn-primary addCityModal"> <i
