<div class="row">
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        {{ Form::text('name', isset($user)?$user->first_name:null, ['class' => 'form-control form-control-solid','required', 'placeholder' => __('messages.company.employer_name')]) }}
    </div>
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group select2-width-input-grp">
            {{ Form::select('state_id', (isset($state) && $state!=null)?$state:[], null, ['id'=>'stateId','class' => 'form-select form-select-solid','placeholder' => 'Select State']) }}
            <div class="input-group-text border-0">
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group">
            {{ Form::select('company_size_id', $data['companySize'], isset($company)?$company->company_size_id:null, ['id'=>'companySizeId','class' => 'form-select form-select-solid','placeholder' => 'Select Employer Size','required']) }}
            <div class="input-group-text border-0">
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        {{ Form::selectYear('established_in', date('Y'), 2000, (isset($company->established_in)) ? $company->established_in : '', ['class' => 'form-select form-select-solid', 'id' => 'establishedIn','placeholder'=>'Select Established Year']) }}
    </div>
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="form-group col-xl-12 col-md-12 col-sm-12 mb-5">
        ...
        {{--        {{ Form::textarea('details', null, ['class' => 'form-control form-control-solid' , 'id' => 'editDetails','rows'=>'5']) }}--}}
        ...
        <div class="row2">
            ...
            <div class="image-input image-input-outline" data-kt-image-input="true">
                <div class="image-input-wrapper w-125px h-125px bgi-position-center"
                     id="logoPreview"
                     style="background-image: url({{!empty($company->user->media[0])) ? $company->user->media[0]->getFullUrl() : asset('assets/img/infyom-logo.png'}})">
                </div>
                <label
