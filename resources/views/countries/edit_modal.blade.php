...
<div id="editModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.country.edit_country') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['required', 'id'=>'editName','class' => 'form-control form-control-solid', 'placeholder' => __('messages.common.name')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('short_code',__('messages.country.short_code').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::text('short_code', null, ['required', 'id'=>'editShortCode','class' => 'form-control form-control-solid', 'placeholder' => __('messages.country.short_code')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('phone_code',__('messages.country.phone_code').(':'), ['class' => 'form-label  fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::text('phone_code', null, ['class' => 'form-control form-control-solid','id'=>'editPhoneCode', 'maxlength' => '4', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'placeholder' => __('messages.country.phone_code')]) }}
                    </div>
                </div>
                <div class="text-right">
