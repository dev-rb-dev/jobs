    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.company.reported_employer_detail') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('employer_name', __('messages.company.employer_name').':', ['class' => 'fw-bolder text-muted mb-3']) }}
                        <p id="showReportedCompany" class="fw-bolder fs-6 text-gray-800"></p>
                    </div>
