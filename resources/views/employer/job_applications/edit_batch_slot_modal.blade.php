    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.job_stage.edit_slot') }}</h2>
            ...
            <div class="modal-body mx-xl-3 mb-7">
                        ...
                        <div class="row p-5">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid"  name="date" id="editDate" required>
                                </div>
                                <div class="form-group mb-0 mt-3">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="time" id="editTime" required>
                                </div>
                            </div>
                            <div class="form-group col-sm-6 mb-0">
                ...
                <div class="d-flex justify-content-end">
                    {{ Form::button(__('messages.common.save'), ['type' => 'submit','class' => 'btn btn-primary me-3','id' => 'editSlotBtnSave','data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
                    <button type="button" class="btn btn-light btn-active-light-primary me-2" id="editSlotBtnCancel" data-bs-dismiss="modal">{{ __('messages.common.cancel') }}</button>
                </div>
            </div>
            {{ Form::close() }}
        </div>
