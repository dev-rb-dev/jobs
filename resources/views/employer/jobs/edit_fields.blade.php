<div class="row">
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        {{ Form::select('job_type_id', $data['jobType'],null, ['id'=>'jobTypeId','class' => 'form-select form-select-solid','placeholder' => 'Select Job Type','required','placeholder' => __('messages.job.job_type')]) }}
    </div>
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="form-group col-xl-12 col-md-12 col-sm-12 mb-5">
        ...
        {{--        {{ Form::textarea('description', null, ['class' => 'form-control form-control-solid' , 'id' => 'details', 'rows' => '5']) }}--}}
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group">
            ...
            {{ Form::text('job_expiry_date', isset($job->job_expiry_date) ? $job->job_expiry_date : null, ['class' => 'form-control form-control-solid expiryDatepicker', 'required', 'placeholder' => __('messages.job.job_expiry_date')]) }}
        </div>
    </div>
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="form-group col-xl-4 col-md-4 col-sm-12 mb-5">
        {{ Form::label('state', __('messages.job.state').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
    ...
    <div class="form-group col-xl-4 col-md-4 col-sm-12 mb-5">
        {{ Form::label('city', __('messages.job.city').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
        {{ Form::label('job_shift_id', __('messages.job.job_shift').':', ['class' => 'form-labe fs-6 fw-bolder text-gray-700 mb-3']) }}
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        {{Form::select('jobTag[]',$data['jobTag'], (count($data['jobTags']) > 0)?$data['jobTags']:null, ['class' => 'form-select form-select-solid','id'=>'tagId','multiple'=>true])}}
    </div>
    <div class="form-group col-xl-6 col-md-6 col-sm-12 mb-5">
