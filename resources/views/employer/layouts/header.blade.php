...
<div id="kt_header" style="" class="header align-items-stretch">
    <!--begin::Container-->
    <div class="container-xxl d-flex align-items-stretch justify-content-between {{getLoggedInUser()->language == 'fr' ? 'p-0' : ''}}">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <a href="{{ route('front.home') }}">
                ...
                <span class="text-white fs-6 text-primary ms-3 logo">{{ getAppName() }}</span>
            </a>
        </div>
        <!--end::Logo-->
        <!--begin::Wrapper-->
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div
                        ...
                        <div class="menu-item me-lg-1">
                            <a class="menu-link py-3 {{ Request::is('employer/dashboard*') ? 'active' : ''}}"
                               href="{{ route('employer.dashboard') }}">
                                <i class="fab fa-dashcube me-2 {{ Request::is('employer/dashboard*') ? 'text-primary' : ''}}"></i><span
                                    class="menu-title">{{ __('messages.dashboard') }}</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link py-3 {{ Request::is('employer/company*') ? 'active' : ''}}"
                               href="{{ route('company.edit.form', \Illuminate\Support\Facades\Auth::user()->owner_id) }}">
                                <i class="far fa-user-circle me-2 {{ Request::is('employer/company*') ? 'text-primary' : ''}}"></i><span
                                    class="menu-title">{{ __('messages.employer_menu.employer_profile') }}</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link py-3 {{ Request::is('employer/jobs*') ? 'active' : ''}}"
                               href="{{ route('job.index') }}">
                                <i class="fas fa-briefcase me-2 {{ Request::is('employer/jobs*') ? 'text-primary' : ''}}"></i><span
                                    class="menu-title">{{ __('messages.employer_menu.jobs') }}</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link py-3 {{ Request::is('employer/job-stage*') ? 'active' : ''}}"
                               href="{{ route('job.stage.index') }}">
                                <i class="fab fa-usps me-2 {{ Request::is('employer/job-stage*') ? 'text-primary' : ''}}"></i><span
                                    class="menu-title">{{ __('messages.job_stages') }}</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link py-3 {{ Request::is('employer/followers*') ? 'active' : ''}}"
                               href="{{ route('followers.index') }}">
                                <i class="fab fa-foursquare me-2 {{ Request::is('employer/followers*') ? 'text-primary' : ''}}"></i><span
                                    class="menu-title">{{ __('messages.employer_menu.followers') }}</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link py-3 {{ Request::is('employer/manage-subscriptions*','employer/payment-method*') ? 'active' : ''}}"
                               href="{{ route('manage-subscription.index') }}">
                                <i class="fa fa-dollar-sign dollar-sign-icon me-2 {{ Request::is('employer/manage-subscriptions*','employer/payment-method*') ? 'text-primary' : ''}}"></i><span
                                    class="menu-title">{{ __('messages.employer_menu.manage_subscriptions') }}</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link py-3 {{ Request::is('employer/transaction*') ? 'active' : ''}}"
                               href="{{ route('transaction.index') }}">
                                <i class="fas fa-money-bill-wave me-2 {{ Request::is('employer/transaction*') ? 'text-primary' : ''}}"></i><span
                                    class="menu-title">{{ __('messages.employer_menu.transactions') }}</span>
                            </a>
                        </div>
                    </div>
                    <!--end::Menu-->
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <img src="{{ getLoggedInUser()->avatar }}" alt="user" class="object-fit-cover" />
                        </div>
                        <!--begin::Menu-->
                        <div
