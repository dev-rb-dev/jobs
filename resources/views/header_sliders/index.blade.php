...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl">
            ...
            {{--                                <span class="custom-switch-description font-weight-bold fs-6 fw-bolder text-gray-700 mb-3 me-3 mb-md-0">{{ __('messages.image_slider.slider') }}--}}
            {{--                            <i class="fas fa-question-circle ml-1"--}}
            {{--                               data-toggle="tooltip" data-placement="top"--}}
                ...
                <div class="card-header border-0 pt-6">
                    <div class="col-lg-9 mt-5">
                        <form method="post" id="searchIsActive">
                            @csrf
                            <div
                                class="form-group col-lg-6 col-sm-12 form-check form-switch form-check-custom col-sm d-block">
                                <label class="custom-switch switch-label">
                                    <input type="checkbox" name="is_active"
                                           class="custom-switch-input searchIsActive form-check-input" {{ ($settings['slider_is_active'] == 1) ? 'checked' : '' }} >
                                    <span class="custom-switch-indicator switch-span"></span>
                                </label>
                                <span
                                    class="custom-switch-description font-weight-bold fs-6 fw-bolder text-gray-700 mb-3 mx-3 mb-md-0">{{ __('messages.image_slider.message') }}
                                     <i class="fas fa-question-circle ml-1"
                    ...
                    <div class="card-toolbar justify-content-end">
                        <div class="d-flex align-items-center py-1">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                                    ...
                                    <div class="px-7 py-5">
                                        <div class="mb-5">
                                            ...
                                            {{ Form::select('is_active', $statusArr,null, ['id' => 'headerFilterStatus', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-filter select2-hidden-accessible data-allow-clear="true"','placeholder' => __('messages.image_slider.select_status')]) }}
                                        </div>
                            ...
                            <a class="btn btn-primary addHeaderSliderModal"><i
