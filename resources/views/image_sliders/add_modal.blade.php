            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        <div class="d-block">
                            {{ Form::label('image_slider', __('messages.image_slider.image').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                            <i class="fas fa-question-circle ml-1 mt-1 general-question-mark"
                               data-toggle="tooltip"
                               data-placement="top"
                               title="{{  __('messages.image_slider.image_title_text') }}"></i>
                        </div>
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            ...
                            <label
                                ...
                                {{ Form::file('image_slider',['id'=>'imageSlider','class' => 'd-none', 'accept' => '.png, .jpg, .jpeg']) }}
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        {{ Form::label('description', __('messages.image_slider.description').':',['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
                        <div id="descriptionId"></div>
                        {{ Form::hidden('description', null, ['id' => 'descriptionData']) }}
                    </div>
                    <div class="form-group col-sm-4 mb-0 pt-1 mt-5">
...
{{--        <div class="modal-content">--}}
{{--            <div class="modal-header">--}}
{{--                <h2>{{ __('messages.image_slider.new_image_slider') }}</h2>--}}
{{--                <button type="button" aria-label="Close" class="btn btn-sm btn-icon btn-active-color-primary"--}}
{{--                        data-bs-dismiss="modal">--}}
{{--                    <span class="svg-icon svg-icon-1">--}}
{{--						<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"--}}
...
{{--                </button>--}}
{{--            </div>--}}
{{--            {{ Form::open(['id'=>'addNewSliderForm','files'=>true]) }}--}}
