...
<div id="addModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.industry.new_industry') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid','required', 'placeholder'=>__('messages.industry.name')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
...
{{--                        {{ Form::textarea('description', null, ['class' => 'form-control form-control-solid','required', 'id'=>'description'])--}}
                           <div id="industryDescription"></div>
