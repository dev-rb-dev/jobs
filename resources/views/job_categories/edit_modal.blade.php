...
{{--                        <div class="row">--}}
{{--                            <div class="pl-3">--}}
{{--                                {{ Form::label('category_image', __('messages.common.category_image').':') }}--}}
...
<div id="editModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.job_category.edit_job_category') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid','required','id' => 'editName', 'placeholder' => __('messages.job_category.name')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5 h-100">
                        ...
                        <div id="editDescription" class="job-category-description"></div>
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        <div class="row">
                            ...
                            {{--                                    <input name="is_featured" class="form-check-input" type="checkbox" value="1"--}}
                            {{--                                           id="editIsFeatured"/>--}}
