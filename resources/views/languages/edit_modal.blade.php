...
<div id="editModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.language.edit_language') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('language', null, ['id'=>'editLanguage','class' => 'form-control form-control-solid','required','placeholder' => __('messages.language.language')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('iso_code',__('messages.language.iso_code').(':'),['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::text('iso_code', '', ['class' => 'form-control form-control-solid', 'id' => 'editIso','placeholder' => __('messages.language.iso_code')]) }}
                    </div>
