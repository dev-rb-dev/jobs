...
<!--   <a title="--><?php //echo __('messages.common.edit') ?>
    <!--" class="btn btn-warning action-btn edit-btn" data-id="{{:id}}" href="#">-->
<!--            <i class="fa fa-edit"></i>-->
<!--   </a>-->
<!--   <a title="--><?php //echo __('messages.common.delete') ?>
    <!--" class="btn btn-danger action-btn delete-btn" data-id="{{:id}}" href="#">-->
...
<label class="form-check form-switch form-check-custom form-check-solid form-switch-sm isActive">
         <input name="Is Active" data-id="{{:id}}" class="form-check-input isActive" type="checkbox" value="1" {{:checked}} data-id="{{:id}}">
