...
<div class="card mb-5 mb-xl-8">
                ...
                @if(count($status) > 0)
                    <div class="me-4">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-5">
                                    {{ Form::select('is_featured', $status,null, ['id' => 'filterCandidateStatus', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-filter select2-hidden-accessible data-allow-clear="true"','placeholder' => 'Select Status']) }}
                                </div>
    ...
    <div class="card-body pt-0 fs-6 py-8 px-8  px-lg-10 text-gray-700">
        <div class="table-responsive">
            @include('selected_candidate.templates.templates')
            @include('selected_candidate.table')
        </div>
    </div>
</div>
