<script id="selectedCandidateActionTemplate" type="text/x-jsrender">
...
<!--        </span>-->  
<!--    </a>-->
    <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 sel-candidate-modal" data-bs-toggle="tooltip" title="Show" data-id={{:id}}>
