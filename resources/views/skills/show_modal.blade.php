...
{{--                <h5 class="modal-title">{{ __('messages.skill.skill_detail') }}</h5>--}}
...
<div id="showModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.skill.skill_detail') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('name',__('messages.skill.name').':', ['class' => 'fw-bolder text-muted mb-3']) }}
                        <p id="showName" class="fw-bolder fs-6 text-gray-800"></p>
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('description', __('messages.skill.description').(':'),['class' => 'fw-bolder text-muted mb-3']) }}
