...
<div id="editModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.state.edit_state') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['id'=>'editName','class' => 'form-control form-control-solid','required', 'placeholder' => __('messages.common.name')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('country_id',__('messages.state.country_name').(':'),['class' => ' required form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('country_id', $countries, null,  ['id' => 'editCountryId','class' => 'form-control form-control-solid','required', 'placeholder' => 'Select Country']) }}
                    </div>
                    <div class="text-right">
