            ...
            <div class="row candidate-profile">
                ...
                <div class="col-md-3 col-xs-12">
                    <div class="profile-photo">
                        <img src="{{ asset('web/img/client4.jpg') }}" class="img-responsive" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row portfolio-grid mt40">
                ...
                <div class="element col-md-4 col-sm-6 col-xs-6 portfolio-cat1">
                    <figure>
                        <a href="{{ asset('web/img/image1.jpg') }}" class="hover-zoom">
                            <img src="{{ asset('web/img/image1.jpg') }}" class="img-responsive" alt="">
                        </a>
                    </figure>
                </div>
            ...
            <div class="col-md-6">
                <div class="item-block shadow-hover">
                    ...
                    <div class="education-header clearfix">
                        <img src="{{ asset('web/img/envato.svg') }}" alt="">
                        <div>
