...
Route::group(['middleware' => ['auth', 'role:Admin|SubAdmin', 'xss', 'verified.user'], 'prefix' => 'admin'], function () {
    ...
    Route::get('subadmins/{subadmin}/edit', [SubAdminController::class, 'edit'])->name('subadmins.edit');
    Route::get('subadmins/{subadmin}', [SubAdminController::class, 'show'])->name('subadmins.show');
    Route::put('subadmins/{subadmin}', [SubAdminController::class, 'update'])->name('subadmins.update');
    Route::delete('subadmins/{subadmin}', [SubAdminController::class, 'destroy'])->name('subadmins.destroy');
    // Route::post('subadmins/{id}/change-status', [SubAdminController::class, 'changeStatus']);
    // Route::post('subadmins/{subadmin}/verify-email',[SubAdminController::class, 'changeIsEmailVerified']);
    // Route::post('subadmins/{subadmin}/resend-email-verification', [SubAdminController::class, 'resendEmailVerification']);
    ...
    //Route::post('jobs/decline', [JobController::class, 'storedecline'])->name('job.declinestore');

    Route::put('jobs', [JobController::class, 'approveJob'])->name('admin.job.approved');

    // Job Published routes
    Route::get('job-published', [JobController::class, 'getPublishJobs'])->name('admin.job-published.index');
    Route::get('jobs/remarks/{job}', [JobController::class, 'showremarks'])->name('admin.jobs.remarks');
    ...
    Route::post('front-settings/{id}/change-is-job-active', [FrontSettingsController::class, 'changeJobFeatured']);
   ...
   //Notice board
    Route::get('admin-notice-boards', [AdminNoticeBoardController::class, 'index'])->name('admin-notice-boards.index');
    Route::post('admin-notice-boards', [AdminNoticeBoardController::class, 'store'])->name('admin-notice-boards.store');
    Route::get('admin-notice-boards/{AdminNoticeBoard}', [AdminNoticeBoardController::class, 'show'])->name('admin-notice-boards.show');
    Route::get('admin-notice-boards/{AdminNoticeBoard}/edit', [AdminNoticeBoardController::class, 'edit'])->name('admin-notice-boards.edit');
    Route::put('admin-notice-boards/{AdminNoticeBoard}', [AdminNoticeBoardController::class, 'update'])->name('admin-notice-boards.update');
    Route::delete('admin-notice-boards/{AdminNoticeBoard}', [AdminNoticeBoardController::class, 'destroy'])->name('admin-notice-boards.destroy');
   //Notice board end
    ...
    // User Role routes
    Route::get('user_permission', [RoleController::class, 'index'])->name('user_role.index');


     // User Permission routes
     Route::get('user_permission', [PermissionController::class, 'index'])->name('user_permission.index');
...
Route::group(['middleware' => ['auth', 'role:Employer', 'xss', 'verified.user'], 'prefix' => 'employer'], function () {
    ...
    Route::get('jobs/status/{jobStatus}', [JobController::class, 'index'])->name('job.jobStatus');
    ...
    //Show Remarks
    Route::get('jobs/remarks/{job}', [JobController::class, 'showremarks'])->name('jobs.remarks');
...
Route::get('/upgrade-to-v9-1-0', function () {
    \Illuminate\Support\Facades\Artisan::call('db:seed',
        ['--class' => 'CreateFrontSettingSeeder']);
});
